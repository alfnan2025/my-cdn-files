...
document.addEventListener("DOMContentLoaded", function () {
    let postContent = document.querySelector(".post-content") || document.querySelector(".post-body");
    ...
    // تحسين النصوص المنسقة
    postContent.querySelectorAll("b, i, u").forEach(element => {
        let newText = document.createElement("span");
        newText.classList.add("formatted-text");
        newText.innerHTML = element.innerHTML; // الحفاظ على النص الأصلي
